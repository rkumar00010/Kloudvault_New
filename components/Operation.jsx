  ...
  return (
    <div id="top" className="min-h-screen bg-white text-slate-900">
              ...
              {heroImgFailed ? (
                <div className="flex min-h-[280px] w-full max-w-xl flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-slate-300 bg-slate-100 px-6 py-12 text-center text-sm text-slate-600">
                  ...
                  <p>
                    ...
                    <span className="rounded bg-white px-1.5 py-0.5 font-mono text-xs">my-app/public/Operation.jpg</span>
                  </p>
                </div>
              ) : (
                <img
                  src={encodeURI(HERO_IMG)}
                  alt="Salesforce call center operations with AI-powered CTI"
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-2xl font-bold text-slate-900 sm:text-3xl">
            AI-led CTI, Built for Operational Success
          </h2>
      ...
      <section className="py-14 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-2xl font-bold text-slate-900 sm:text-3xl">Real Stories, Real Results</h2>
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            {testimonials.map((t) => (
              <article
                key={t.name}
                className="relative flex min-h-[280px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 p-8"
              >
